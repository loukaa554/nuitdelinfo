...
import { Component as ChartComponent, Component } from "@/components/vision/Component";
...
export default function Page() {
          ...
          <div className="dashboard flex flex-1 flex-col gap-4 p-4">
            ...
            <div className="max-h-[10vh] aspect-video rounded-xl bg-muted/50 flex items-center justify-between p-4">
              <div className="flex flex-col items-start gap-1">
                ...
                <p className="text-sm text-muted-foreground">Voici un aperçu rapide de vos données.</p>
              </div>
                ...
                <div className="rounded-lg p-4 shadow-md">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-muted-foreground">2 heures</span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span className="text-sm">26/07/25</span>
                      <span className="text-xs text-muted-foreground">3 heures</span>
                    </li>
                  </ul>
                </div>
              </div>
  ...
  return (
    <SidebarProvider>
      <AppSidebar
        onSectionChange={(section: React.SetStateAction<string>, page: React.SetStateAction<string>) => {
